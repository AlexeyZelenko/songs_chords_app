  ...
  Widget build(BuildContext context) {
    return CurvedNavigationBar(
      ...
      onTap: (index)
      {
        if(index == 0)
        {
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => SongScreen()));
        }
        else if(index == 1)
        {
        ...
        {
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => UploadSongNow()));
        }
        else if(index == 3)
        {
          final FirebaseAuth _auth = FirebaseAuth.instance;
