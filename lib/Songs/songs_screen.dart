...
import '../Search/search_song.dart';
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (ctx, index)
                  {
                    return InkWell(
                      onTap: (){
                        setState((){
                          songCategoryFilter = Persistent.songCategoryList[index];
                        });
                        Navigator.canPop(context) ? Navigator.pop(context) : null;
                        print(
                            'songlmkjlkCategoryList[index], ${Persistent.songCategoryList[index]}'
                        );
                      },
                      child: Row(
                        children: [
      ...
      child: Scaffold(
          ...
          body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              stream: FirebaseFirestore.instance
                  .collection('songs')
                  .where('songCategory', isEqualTo: songCategoryFilter)
